  ...
  const sendData = async (e) => {
    ...
    const requiredFields = [
      'title', 'company', 'location', 'category',
       'aboutCompany', 'aboutJob', 
      'whoCanApply', 'perks', 'numberOfOpening', 
      'CTC', 'startDate', 'AdditionalInfo'
    ];
      ...
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <form className="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2" onSubmit={sendData} >
          ...
          <div>
            ...
            <input name="title" value={formData.title} onChange={handleChange} className="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
          </div>

          <div>
            <label for="company" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Company Name*</label>
            <input name="company" value={formData.company} onChange={handleChange} className="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
          </div>
          ...
          <div className="sm:col-span-2">
            <label for="aboutJob" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">About Job*</label>
            <textarea name="aboutJob" value={formData.aboutJob} onChange={handleChange} className="h-64 w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring"></textarea>
          </div>
          <div className="sm:col-span-2">
          ...
          <div className="sm:col-span-2">
            ...
            <input name="perks" value={formData.perks} onChange={handleChange} className=" w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring"></input>
          </div>
          <div className="sm:col-span-2">
            <label for="numberOfOpening" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Number Of Openings*</label>
          ...
          <div className="sm:col-span-2">
            <label for="CTC" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">CTC*</label>
            <input name="CTC" value={formData.CTC} onChange={handleChange} className=" w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring"></input>
          </div>
          <div className="sm:col-span-2">
            <label for="experience" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Experience*</label>
            <input name="experience" value={formData.experience} onChange={handleChange} className=" w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring"></input>
          </div>
          <div className="sm:col-span-2">
          ...
          <div className="sm:col-span-2">
            ...
            <textarea name="AdditionalInfo" value={formData.AdditionalInfo} onChange={handleChange} className="h-12 w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring"></textarea>
          </div>

          <div className='button-container'>
            <button type="submit" className='postJobbtn'>Post Job</button>
          </div>
        </form>
      </div>
    </div>
